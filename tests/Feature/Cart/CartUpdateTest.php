...
class CartUpdateTest extends TestCase
{
    ...
    public function test_it_requries_a_quantity()
    {
        $user = factory(User::class)->create();
    ...
    public function test_it_requries_a_numeric_quantity()
    {
        $user = factory(User::class)->create();
    ...
    public function test_it_requries_a_quantity_of_one_or_more()
    {
        $user = factory(User::class)->create();
